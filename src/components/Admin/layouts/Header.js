        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          ...
          <div className="avata-account">
            ...
            <div className="dropdown-menu-hover">
              <Link className="dropdown-item" to="/"><i className="fas fa-user-circle mr-2" />Profile</Link>
              <Link className="dropdown-item" to="/"><i className="fas fa-sign-out-alt mr-2" />Logout</Link>
            </div>
          </div>
        </nav>
      </div>
